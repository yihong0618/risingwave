...
import com.risingwave.connector.SourceHandlerIpc;
...
import com.risingwave.sourcenode.types.TableSchema;
...
public class SourceValidateHandlerIpc {
    static final Logger LOG = LoggerFactory.getLogger(SourceValidateHandlerIpc.class);
    ...
    public static void validateDbProperties(
