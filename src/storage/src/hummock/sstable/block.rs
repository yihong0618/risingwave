...
mod tests {
    ...
    fn test_compress_sst() {
        let sst1 = fs::read_to_string("/Users/wangcongyi/Desktop/68.txt")
            .unwrap()
            .into_bytes();
        let mut encoder =
        ...
        println!("\n-----sst2------");
        let sst2 = fs::read_to_string("/Users/wangcongyi/Desktop/76.txt")
            .unwrap()
            .into_bytes();
        ...
        println!("\n-----sst3------");
        let sst3 = fs::read_to_string("/Users/wangcongyi/Desktop/79.txt")
            .unwrap()
            .into_bytes();
        let mut encoder =
