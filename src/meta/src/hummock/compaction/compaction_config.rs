...
const DEFAULT_TIER_COMPACT_TRIGGER_NUMBER: u64 = 15;
...
const DEFAULT_MAX_COMPACTION_FILE_COUNT: u64 = 500;
const DEFAULT_MIN_SUB_LEVEL_COMPACT_LEVEL_COUNT: u32 = 12;
const DEFAULT_MIN_OVERLAPPING_SUB_LEVEL_COMPACT_LEVEL_COUNT: u32 = 25;
