...
impl HummockManager {
    ...
    pub async fn get_compact_task_impl(
        ...
        for trivial_task in &trivial_task_vec {
            tracing_compact_task(self.metrics.clone(), trivial_task, cost_time);
        }
    ...
    pub async fn get_compact_task(
        ...
        loop {
            ...
            if !trivial_task_vec.is_empty() {
                self.report_trivial_task_impl(trivial_task_vec, None)
                    .await?;
            }
    ...
    pub async fn report_compact_task_impl(
        ...
        let compact_task = {
            ...
            let mut branched_ssts: BTreeMapTransaction<'_, u64, HashMap<u64, u64>> =
    ...
    pub async fn report_trivial_task_impl(
...

        {
            ...
            let mut succ_compact_tasks = Vec::with_capacity(compact_tasks.len());
        ...
        tracing::trace!(
            "Reported trivial task. cost time: {:?}",
            start_time.elapsed(),
        );
