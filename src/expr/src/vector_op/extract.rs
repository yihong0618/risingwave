...
use risingwave_common::types::{Decimal, NaiveDateTimeWrapper, NaiveDateWrapper, Timestamptz};
...
pub fn extract_from_timestamptz(time_unit: &str, tz: Timestamptz) -> Result<Decimal> {
    match time_unit {
