...
use risingwave_common::types::{NaiveDateTimeWrapper, OrderedF64, Timestamptz};
...
#[inline(always)]
pub fn f64_sec_to_timestamptz(elem: OrderedF64) -> Result<Timestamptz> {
...
#[inline(always)]
pub fn timestamp_at_time_zone(input: NaiveDateTimeWrapper, time_zone: &str) -> Result<Timestamptz> {
