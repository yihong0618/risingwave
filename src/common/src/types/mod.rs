...
pub use self::timestamptz::Timestamptz;
...
impl DataType {
    ...
    pub fn create_array_builder(&self, capacity: usize) -> ArrayBuilderImpl {
        ...
        match self {
            ...
            DataType::Timestamptz => PrimitiveArrayBuilder::<Timestamptz>::new(capacity).into(),
...
impl ScalarRefImpl<'_> {
    ...
    pub fn serialize(
        ...
        match self {
            ...
            Self::Timestamptz(v) => v.0.serialize(ser)?,
...
impl ScalarImpl {
    ...
    pub fn deserialize(
        ...
        Ok(match ty {
            ...
            Ty::Timestamptz => Self::Timestamptz(Timestamptz(i64::deserialize(de)?)),
        ...
        Some(datum) => {
            matches!(
                ...
                (DataType::Boolean, ScalarImpl::Bool(_))
                    ...
                    | (DataType::Timestamptz, ScalarImpl::Timestamptz(_))
    ...
    fn test_hash_implementation() {
        ...
        for name in DataTypeName::iter() {
            let (scalar, data_type) = match name {
                ...
                DataTypeName::Timestamptz => (
                    ScalarImpl::Timestamptz(Timestamptz(233333333)),
